...
var config = {
    apiKey: "AIzaSyBWqjxtwW0dr9BggtXB5-ouKf5jEdnXRxc",
    authDomain: "ffb-app-a7643.firebaseapp.com",
    databaseURL: "https://ffb-app-a7643.firebaseio.com",
    projectId: "ffb-app-a7643",
    storageBucket: "ffb-app-a7643.appspot.com",
    messagingSenderId: "477061817524"
};
...
database.ref().on("child_added", function(childSnapshot, prevChildKey) {
    ...
    playerPos = childSnapshot.val().pos;
    playerRank = childSnapshot.val().rank;
    pickedPlayers.push(playerRank);
...
$(".pickedPos").on("click", ".playerName", function() {
    ...
    ref.orderByChild('name').equalTo(playerName).on("child_added", function(snapshot) {
